package ar.edu.huergo.aguilar.borassi.tunari.controller;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleTooManyRequestsException(TooManyRequests ex){
        ProblemDetail problem = ProblemDetail.forStatus(HttpStatus.TOO_MANY_REQUESTS);
        problem.setTitle("Demasiadas solicitudes");
        problem.setDetail(ex.getMessage());
        problem.setType(URI.create("https://http.dev/429"));
        return problem;
    }
}
